        ...
        public override SKPoint Draw(ZplElementBase element, DrawerOptions options, SKPoint currentPosition, InternationalFont internationalFont)
        {
            if (element is ZplBarcodeInterleaved2of5 barcode)
            {
                ...
                if (barcode.PrintInterpretationLine)
                {
                    ...
                    this.DrawInterpretationLine(content, labelFontSize, x, y, resizedImage.Width, resizedImage.Height, barcode.FieldOrigin != null, barcode.FieldOrientation, barcode.PrintInterpretationLineAboveCode, options);
                }
